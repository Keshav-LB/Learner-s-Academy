...
<body>
	...
	%>
	<form action="teachercontroller" method="post" style="width: 400px; margin: 0px auto;">
		<fieldset>
			<legend>Add Teacher form</legend><br>
			<label>Name : </label><input type="text" name="teachername" required>
			<p>
				<label>Qualification : </label> <select name="qualification" id="qualification" required>
